...
#cat key.pem cert.pem >> /etc/stunnel4/stunnel4.pem

# Service Stunnel5 systemctl restart stunnel4
...
wget -O sstpmenu "https://raw.githubusercontent.com/acelrth/Mantap/main/update/sstpmenu.sh"
