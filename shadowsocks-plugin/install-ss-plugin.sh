...
CYAN='\033[0;36m'
LIGHT='\033[0;37m'
# https://raw.githubusercontent.com/Acelrrh/scriptvps/main/ip
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/Acelrrh/scriptvps/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Acelrrh/scriptvps/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/Acelrrh/mantap/main/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
#wget -O shadowhost "https://raw.githubusercontent.com/Acelrrh/mantap/main/shadowsocks-plugin/shadowhost.sh"
#chmod +x shadowhost && shadowhost
wget -O delss "https://raw.githubusercontent.com/Acelrrh/mantap/main/shadowsocks/delss.sh"
cd
...
rm -rf gost-plugin
cd /usr/bin/
wget -O gost-plugin "https://raw.githubusercontent.com/Acelrrh/Shadowsocks-Plugin/main/gost-plugin"
wget -O v2ray-plugin "https://raw.githubusercontent.com/Acelrrh/Shadowsocks-Plugin/main/v2ray-plugin"
wget -O xray-plugin "https://raw.githubusercontent.com/Acelrrh/Shadowsocks-Plugin/main/xray-plugin"
chmod +x gost-plugin
...
wget -O gost-plugin-arm.zip "https://raw.githubusercontent.com/Acelrrh/Shadowsocks-Plugin/main/gost-plugin-arm.zip"
wget -O gost-plugin-x86.zip "https://raw.githubusercontent.com/Acelrrh/Shadowsocks-Plugin/main/gost-plugin-x86.zip"
wget -O v2ray-plugin-universal.apk "https://raw.githubusercontent.com/Acelrrh/Shadowsocks-Plugin/main/v2ray-plugin-universal-v4.44.0.apk"
wget -O xray-plugin-universal.apk "https://raw.githubusercontent.com/Acelrrh/Shadowsocks-Plugin/main/xray-plugin-universal-v1.5.4.apk"
