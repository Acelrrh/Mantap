...
echo -e " [\e[36m•2\e[0m] L2TP MENU(maintenece)"
echo -e " [\e[36m•3\e[0m] PPTP MENU(maintenece)"
echo -e " [\e[36m•4\e[0m] SSTP MENU(maintenece)"
echo -e " [\e[36m•5\e[0m] WIREGUARD MENU(maintenece)"
echo -e " [\e[36m•6\e[0m] SHADOWSOCKS MENU"
echo -e " [\e[36m•7\e[0m] SHADOWSOCKSR MEN"maintenece"
